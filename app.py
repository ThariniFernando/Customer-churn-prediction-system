...
@st.cache_resource
def load_model():
    return pickle.load(open('res/random_forest_model.pkl', 'rb'))
...
MonthlyCharges = st.number_input("Enter monthly charges of the customer", min_value=0.0)
TotalCharges = st.number_input("Enter total charges of the customer", min_value=0.0)
